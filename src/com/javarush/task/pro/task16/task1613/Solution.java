...
public class Solution {
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        ...
        return (dateTime.getDayOfWeek().equals(DayOfWeek.FRIDAY) && (dateTime.getHour() >= WEEKEND_START_FRIDAY_CUT_OFF_HOUR)) ||
                dateTime.getDayOfWeek().equals(DayOfWeek.SATURDAY) ||
                (dateTime.getDayOfWeek().equals(DayOfWeek.SUNDAY) && (dateTime.getHour() < WEEKEND_END_SUNDAY_CUT_OFF_HOUR));
    }
}
