    ...
    static void fixDate(List<Date> brokenDates) {
        ...
        for (int i = 0; i < brokenDates.size(); i++) {
            if (brokenDates.get(i).after(currentDate)) {
                brokenDates.get(i).setYear(brokenDates.get(i).getMonth() == 0 ? brokenDates.get(i).getYear() - 1901 : brokenDates.get(i).getYear() - 1900);
                brokenDates.get(i).setMonth(brokenDates.get(i).getMonth() == 0 ? 11 : brokenDates.get(i).getMonth() - 1);
            }
        }
    }
}
