    ...
    private static class Handler extends Thread {
        ...
        public void run() {
            ...
            try (Connection connection = new Connection(socket)) {
                ...
                ConsoleHelper.writeMessage("Произошла ошибка при обмене данными с адресом: " + socket.getRemoteSocketAddress());
            } finally {
                if (userName != null) {
         ...
         * @param userName - имя участника, которому будем слать информацию
         * @throws IOException
         */
